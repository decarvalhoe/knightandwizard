<?php
	...
	require_once('../' . P_DIR_MAN . 'user/' . 'PotionsListMan.php');
	...
	if($_SESSION['User'] != NULL){
		...
		$potionsArray = $Manager->getAllPotions($_DB, $_GET['order']);

		// Assignations Smarty
		$smarty->assign('DIR_SITE', DIR_SITE);
		$smarty->assign('potionsArray', $potionsArray);

		// Affichage de la page
		$smarty->display('header.tpl');
		$smarty->display('potions-list.tpl');
