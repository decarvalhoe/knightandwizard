<?php
	...
	require_once('../' . P_DIR_MAN . 'user/' . 'AllCharactersMan.php');
	...
	if($_SESSION['User'] != NULL){
		...
		$_DB = new _DBManager();
		$Manager = new AllCharactersMan();

		// Recuperation des personnages joueur du user
		$CharactersArray = $Manager->getActivesCharacters($_DB);
		...
		$smarty->display('all-characters.tpl');
