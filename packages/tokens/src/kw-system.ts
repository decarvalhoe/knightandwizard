...
export const skins = {
  ...
  gazette: {
    surface: 'Dashboard / Session / Assistant',
    jour: {
      'bg-canvas': '#EDE2B6',
      'bg-surface': '#F4ECCC',
      'bg-elevated': '#FAF4E5',
  ...
  armorial: {
    surface: 'Fiche / Catalogues / Carte / Lore',
    jour: {
      'bg-canvas': '#EFE2B6',
      'bg-surface': '#F6ECCB',
      'bg-elevated': '#FBF4DF',
      'text-ink': '#1F1810',
      'text-muted': '#5C4E32',
      'border-hairline': '#B89F6C',
      'border-rule': '#1F1810',
      accent: '#8B1F1F',
      'accent-2': '#1F4870'
    },
    veilleeAccent: { accent: '#C7544A', 'accent-2': '#7C9FBE' },
    fonts: {
      display: "'Cormorant SC', serif",
      body: "'EB Garamond', Georgia, serif",
      label: "'Cormorant SC', serif"
...
/** Émaux héraldiques — système d'accent par nation (Armorial / Cartulaire, cf. §4). */
export const emaux = {
  gueules: { label: 'Gueules (rouge)', color: '#8B1F1F' },
  azur: { label: 'Azur (bleu)', color: '#1F4870' },
  or: { label: 'Or (jaune)', color: '#B68842' },
  sinople: { label: 'Sinople (vert)', color: '#4D5E2A' }
} as const;
